...
android {
    ...
    defaultConfig {
        ...
        // Expose Gemini key securely via BuildConfig (key lives in local.properties only)
        buildConfigField(
            "String",
            "GEMINI_API_KEY",
    ...
    buildFeatures {
        viewBinding = true
        compose = true
        buildConfig = true   // required to generate BuildConfig with custom fields
    }
    lint {
        abortOnError = false
    }
...
dependencies {
    ...
    // Google Generative AI – using REST API directly (no SDK needed)
    // The free Gemini API is called via HttpURLConnection in GeminiService.kt
